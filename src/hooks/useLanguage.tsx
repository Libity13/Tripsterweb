...
const translations = {
  th: {
    ...
    // Trip CRUD Translations
    'trip.delete': 'ลบแผน',
    'trip.edit': 'แก้ไข',
    'trip.duplicate': 'สำเนา',
    'trip.deleting': 'กำลังลบ...',
    'trip.deleteConfirm.title': 'ยืนยันการลบแผนการเดินทาง',
    'trip.deleteConfirm.message': 'คุณต้องการลบ "{name}" หรือไม่?',
    'trip.deleteConfirm.warning': 'การดำเนินการนี้ไม่สามารถย้อนกลับได้',
    'trip.deleteConfirm.button': 'ลบแผน',
    'trip.deleteSuccess': 'ลบแผนการเดินทางเรียบร้อยแล้ว',
    'trip.deleteError': 'ไม่สามารถลบแผนได้ กรุณาลองใหม่',
    // Share Translations
    'share.title': 'แชร์แผนการเดินทาง',
    'share.description': 'แชร์แผนการเดินทางนี้กับเพื่อนและครอบครัว',
    'share.publicLink': 'เปิดลิงก์สาธารณะ',
    'share.publicDesc': 'ทุกคนที่มีลิงก์สามารถดูแผนได้',
    'share.privateDesc': 'เฉพาะคุณเท่านั้นที่เห็นแผนนี้',
    'share.scanQR': 'สแกน QR Code เพื่อดูบนมือถือ',
    'share.shareVia': 'แชร์ผ่าน',
    'share.share': 'แชร์',
    'share.copyLink': 'คัดลอกลิงก์',
    'share.copied': 'คัดลอกแล้ว!',
    'share.enabled': 'เปิดแชร์เรียบร้อย',
    'share.disabled': 'ปิดแชร์เรียบร้อย',
    'share.error': 'ไม่สามารถแชร์ได้ กรุณาลองใหม่',
    'share.viewTrip': 'ดูแผนการเดินทาง',
    'share.loginToEdit': 'เข้าสู่ระบบเพื่อแก้ไขหรือคัดลอก',
    'share.copyToAccount': 'คัดลอกไปยังบัญชีของฉัน',
    'share.sharedBy': 'แชร์โดย',
    // Export PDF Translations
    'export.button': 'Export PDF',
    'export.title': 'ดาวน์โหลด PDF',
    'export.description': 'เลือกภาษาสำหรับไฟล์ PDF',
    'export.selectLanguage': 'เลือกภาษา',
    'export.success': 'ดาวน์โหลด PDF สำเร็จ!',
    'export.error': 'ไม่สามารถสร้าง PDF ได้ กรุณาลองใหม่',
    'export.info': 'PDF จะประกอบด้วยกำหนดการทั้งหมดของคุณ',
    ...
    'loginModal.facebookSignIn': 'เข้าสู่ระบบด้วย Facebook',
    'loginModal.facebookSignUp': 'สมัครสมาชิกด้วย Facebook',
    ...
    'loginModal.errorFacebook': 'Facebook Sign In ไม่สำเร็จ',
  ...
  en: {
    ...
    'trip.deleteConfirm.title': 'Confirm deletion',
    'trip.deleteConfirm.message': 'Delete "{name}"?',
    'trip.deleteConfirm.warning': 'This action cannot be undone',
    'trip.deleteConfirm.button': 'Delete trip',
    'trip.deleteSuccess': 'Trip deleted successfully',
    'trip.deleteError': 'Failed to delete trip. Please try again.',
    // Share Translations
    'share.title': 'Share Trip',
    'share.description': 'Share this trip with friends and family',
    'share.publicLink': 'Enable public link',
    'share.publicDesc': 'Anyone with the link can view',
    'share.privateDesc': 'Only you can see this trip',
    'share.scanQR': 'Scan QR code to view on mobile',
    'share.shareVia': 'Share via',
    'share.share': 'Share',
    'share.copyLink': 'Copy link',
    'share.copied': 'Copied!',
    'share.enabled': 'Sharing enabled',
    'share.disabled': 'Sharing disabled',
    'share.error': 'Failed to share. Please try again.',
    'share.viewTrip': 'View Trip',
    'share.loginToEdit': 'Sign in to edit or copy',
    'share.copyToAccount': 'Copy to my account',
    'share.sharedBy': 'Shared by',
    // Export PDF Translations
    'export.button': 'Export PDF',
    'export.title': 'Download PDF',
    'export.description': 'Select language for the PDF file',
    'export.selectLanguage': 'Select Language',
    'export.success': 'PDF downloaded successfully!',
    'export.error': 'Failed to generate PDF. Please try again.',
    'export.info': 'The PDF will include your complete itinerary',
    // Login Modal Translations
    ...
    'loginModal.facebookSignIn': 'Sign in with Facebook',
    'loginModal.facebookSignUp': 'Sign up with Facebook',
    ...
    'loginModal.errorFacebook': 'Facebook Sign In failed',
