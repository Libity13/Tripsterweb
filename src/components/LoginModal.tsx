...
const LoginModal = ({ isOpen, onClose, onSuccess }: LoginModalProps) => {
  ...
  const handleFacebookSignIn = async () => {
    try {
      ...
      // Facebook OAuth will redirect, so we don't need to handle success here
    } catch (error) {
      console.error('Facebook Sign In error:', error);
      const errorMessage = error instanceof Error ? error.message : t('loginModal.errorFacebook');
      toast.error(errorMessage);
      setLoading(false);
    }
  };
            ...
            <TabsContent value="signin">
              <form onSubmit={handleSignIn} className="space-y-4">
                ...
                >
                  ...
                  {loading ? t('loginModal.signInLoading') : t('loginModal.facebookSignIn')}
                </Button>
            ...
            <TabsContent value="signup">
              <form onSubmit={handleSignUp} className="space-y-4">
                ...
                >
                  ...
                  {loading ? t('loginModal.signUpLoading') : t('loginModal.facebookSignUp')}
                </Button>
              </form>
            </TabsContent>
          </Tabs>
